...
cd "/home/prashanth/PartFour/src/arbotix_ros/arbotix_sensors"
...
/usr/bin/env \
    ...
    "/usr/bin/python" \
    "/home/prashanth/PartFour/src/arbotix_ros/arbotix_sensors/setup.py" \
    build --build-base "/home/prashanth/PartFour/build/arbotix_ros/arbotix_sensors" \
    install \
    $DESTDIR_ARG \

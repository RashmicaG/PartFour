...
class BlocksWorld:
    def __init__(self):
        ...
        srv_performActions = rospy.Service('', AspCurrentState, self.addNewBlocks)
                ...
                if self.arm.base_rect.colliderect(block.rect):
                    ...
                    if lpx > bx + bw/2:
                        ...
                        if lpx+lpw > left_side and lpx <= left_side:
                            ...
                            if block.shape.width >= self.arm.pincher_seperation-rpw+10:
